...
> store your bookmarks in "$HOME/.local/share/config_dotfiles/bookmarks/" directory in `.txt` files to make the bookmark scripts work. Some examples are already provided
